...
<div class="container-fluid mt-12 bg-dark flex">
             ...
             <!-- Botón Hamburguesa para dispositivos móviles -->
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                  ...
                  <li class="nav-item">
                    <a class="nav-link text-white" href="intranet/inicio_sesion.php">Mi cuenta</a>
                  </li>
                </ul>
              </div>
            </div>
    ...
    <div class="text-center">
        <h1 class="mb-4">Descubre el arte hecho Amanita</h1>
        <h2 class="mb-5">Todo en un solo lugar</h2>
        <!-- Barra de búsqueda -->   
